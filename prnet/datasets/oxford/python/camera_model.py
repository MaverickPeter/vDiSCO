...
class CameraModel:
    ...
    def project(self, xyz, image_size):
        ...
        xyzw = np.dot(np.linalg.inv(self.G_camera_image), xyz)
        # xyzw = xyzw.transpose()
        ...
        uv = np.vstack((self.focal_length[0] * (320./512.) * xyzw[0, :] / xyzw[2, :] + (self.principal_point[0] + 0.)* (320./512.),
                        self.focal_length[1] * (320./512.) * xyzw[1, :] / xyzw[2, :] + (self.principal_point[1] - 200.)* (320./512.)))
